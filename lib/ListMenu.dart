...
import 'package:flutter_apps/views/Kategori/MenuKategori.dart';
import 'package:flutter_apps/views/Produk/MenuProduk.dart';
import 'package:flutter_apps/views/Satuan/MenuSatuan.dart';
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (contex) => new MenuKategori()));
                },
              ),
            ),
