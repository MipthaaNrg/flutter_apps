...
import 'package:flutter_apps/ListMenu.dart';
import 'package:flutter_apps/RiwayatTransaksi/Riwayat.dart';
import 'package:flutter_apps/models/KeranjangModel.dart';
import 'package:flutter_apps/models/ProdukModel.dart';
import 'package:flutter_apps/models/api.dart';
import 'package:flutter_apps/utils/constans.dart';
import 'package:flutter_apps/views/Cart/Cart.dart';
import 'package:flutter_apps/views/Login/LoginPage.dart';
import 'package:flutter_apps/views/Produk/DetailProduk.dart';
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          leading: Padding(
            ...
            child: IconButton(
              icon: Icon(Icons.menu, size: 32, color: Colors.green),
          ...
          title: ClipRRect(
            ...
            child: Image.asset("assets/img/logo1.jpg", height: 100, width: 100),
          ),
          actions: <Widget>[
            Stack(
              children: <Widget>[
          ...
          child: ListView(
            ...
            children: <Widget>[
              UserAccountsDrawerHeader(
                accountName: new Text("Miptha Nrg"),
                accountEmail: new Text("mipthanrg8@gmail.com"),
                decoration: new BoxDecoration(color: Colors.green),
                currentAccountPicture: new CircleAvatar(
                  backgroundImage: AssetImage('assets/img/user (1).png'),
                ),
              ),
              ListTile(
                title: Text("Home"),
