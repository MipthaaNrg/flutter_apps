...
import 'package:flutter_apps/models/CartModel.dart';
...
import 'package:flutter_apps/views/Cart/checkout.dart';
...
// proses minus qty in cart
  minusQtyinCart(String idProduk, String harga, String paramUserId) async {
    final response = await http.post(BaseURL.apiMinCart,
        body: {"userid": paramUserId, "id_barang": idProduk, "harga": harga});
    final data = jsonDecode(response.body);
    int code = data['code'];
    String pesan = data['message'];
